...
def test_atributo_creation():
    ...
    # __str__ agora inclui o nome da categoria
    assert "Teste Atributo" in str(atributo)
    assert atributo.categoria is not None
...
def test_calcular_preco_final_without_modifiers():
    ...
    # Adiciona valor sem modificadores (usa categoria do produto)
    atributo = AtributoFactory(nome="Cor", categoria=produto.categoria)
    valor = ValorAtributoFactory(
        atributo=atributo,
        valor="Normal",
...
def test_calcular_preco_final_with_fixed_modifier():
    ...
    # Adiciona valor com preço adicional fixo (usa categoria do produto)
    atributo = AtributoFactory(nome="Cor", categoria=produto.categoria)
    valor = ValorAtributoFactory(
        atributo=atributo,
        valor="Premium",
...
def test_calcular_preco_final_with_percentage_modifier():
    ...
    # Adiciona valor com percentual adicional (usa categoria do produto)
    atributo = AtributoFactory(nome="Tamanho", categoria=produto.categoria)
    valor = ValorAtributoFactory(
        atributo=atributo,
        valor="GG",
        preco_adicional=Decimal('0'),
...
def test_calcular_preco_final_with_both_modifiers():
    ...
    # Adiciona valor com ambos modificadores (usa categoria do produto)
    atributo = AtributoFactory(nome="Cor", categoria=produto.categoria)
    valor = ValorAtributoFactory(
        atributo=atributo,
        valor="Especial",
...
def test_calcular_preco_final_multiple_attributes():
    ...
    # Cor com preço adicional (usa categoria do produto)
    cor_attr = AtributoFactory(nome="Cor", categoria=produto.categoria)
    ...
    # Tamanho com percentual adicional (usa categoria do produto)
    tam_attr = AtributoFactory(nome="Tamanho", categoria=produto.categoria)
...
def test_calcular_preco_final_no_price():
    ...
    # Adiciona valor com modificadores (usa categoria do produto)
    atributo = AtributoFactory(nome="Cor", categoria=produto.categoria)
    valor = ValorAtributoFactory(
        atributo=atributo,
        valor="Premium",
...
def test_calcular_preco_final_precision():
    ...
    # Percentual que gera casas decimais (usa categoria do produto)
    atributo = AtributoFactory(nome="Tamanho", categoria=produto.categoria)
    valor = ValorAtributoFactory(
        atributo=atributo,
        valor="GG",
